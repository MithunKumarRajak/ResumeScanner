...
Reads the DATABASE_URL from app.config (which loads .env),
and uses the shared Base.metadata for autogenerate support.
"""
...
# Override sqlalchemy.url from .env rather than alembic.ini
